...
public class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        for (Activity activity : activities) {
            if (activity.getIdType() == sectionNumber || sectionNumber == 8) {
                ...
                if (activityYear == actualYear) {
                    ...
                    double timePartialYear = routesMethods.getHours(points);
        ...
        distance.setText(Math.round(distanceDYear) + " " + getString(R.string.km));
        ...
        distanceAll.setText(Math.round(distanceD) + " " + getString(R.string.km));
